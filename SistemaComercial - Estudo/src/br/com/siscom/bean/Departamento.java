 ...
 */
@Entity
@Table(name = "departamento",schema = "")
@NamedQueries({@NamedQuery(name = "Departamento.findByCodDepartamento", query = "SELECT d FROM Departamento d WHERE d.codDepartamento = :codDepartamento"), @NamedQuery(name = "Departamento.findByNomeDepartamento", query = "SELECT d FROM Departamento d WHERE d.nomeDepartamento = :nomeDepartamento")})
