 ...
 */
@Entity
@Table(name = "nfe_det",schema = "")
@NamedQueries({@NamedQuery(name = "NfeDet.findByCodProduto", query = "SELECT n FROM NfeDet n WHERE n.nfeDetPK.codProduto = :codProduto"), @NamedQuery(name = "NfeDet.findByNumeroNfeCab", query = "SELECT n FROM NfeDet n WHERE n.nfeDetPK.numeroNfeCab = :numeroNfeCab"), @NamedQuery(name = "NfeDet.findByQtdeNfeDet", query = "SELECT n FROM NfeDet n WHERE n.qtdeNfeDet = :qtdeNfeDet"), @NamedQuery(name = "NfeDet.findByVlrUnitNfeDet", query = "SELECT n FROM NfeDet n WHERE n.vlrUnitNfeDet = :vlrUnitNfeDet"), @NamedQuery(name = "NfeDet.findByVlrTotalNfeDet", query = "SELECT n FROM NfeDet n WHERE n.vlrTotalNfeDet = :vlrTotalNfeDet")})
public class NfeDet implements Serializable {
    ...
    public String toString() {
        return "br.com.siscom.bean.estoque.NfeDet[nfeDetPK=" + nfeDetPK + "]";
    }
