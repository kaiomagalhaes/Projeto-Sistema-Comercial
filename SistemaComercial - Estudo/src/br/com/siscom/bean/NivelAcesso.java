...
@NamedQueries({
    ...
    @NamedQuery(name = "NivelAcesso.verifiqueAcesso", query = "SELECT n FROM NivelAcesso n WHERE n.codFunc = :codFunc and n.nomeModulo = :nomeModulo")
...
public class NivelAcesso implements Serializable {
    ...
    public String toString() {
        return "br.com.siscom.bean.NivelAcesso[codigo=" + codigo + "]";
    }
