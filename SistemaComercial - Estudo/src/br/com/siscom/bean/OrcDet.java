 ...
 */
@Entity
@Table(name = "orc_det",schema = "")
@NamedQueries({@NamedQuery(name = "OrcDet.findByCodOrcCab", query = "SELECT o FROM OrcDet o WHERE o.orcDetPK.codOrcCab = :codOrcCab"), @NamedQuery(name = "OrcDet.findByCodProduto", query = "SELECT o FROM OrcDet o WHERE o.orcDetPK.codProduto = :codProduto"), @NamedQuery(name = "OrcDet.findByQtdeOrcDet", query = "SELECT o FROM OrcDet o WHERE o.qtdeOrcDet = :qtdeOrcDet"), @NamedQuery(name = "OrcDet.findByVlrUnitOrcDet", query = "SELECT o FROM OrcDet o WHERE o.vlrUnitOrcDet = :vlrUnitOrcDet"), @NamedQuery(name = "OrcDet.findByVlrTotalOrcDet", query = "SELECT o FROM OrcDet o WHERE o.vlrTotalOrcDet = :vlrTotalOrcDet")})
public class OrcDet implements Serializable {
    ...
    public String toString() {
        return "br.com.siscom.bean.OrcDet[orcDetPK=" + orcDetPK + "]";
    }
