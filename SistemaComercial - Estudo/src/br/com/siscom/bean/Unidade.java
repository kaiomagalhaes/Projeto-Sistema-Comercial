...
@NamedQueries({@NamedQuery(name = "Unidade.findByCodUnidade", query = "SELECT u FROM Unidade u WHERE u.codUnidade = :codUnidade"), @NamedQuery(name = "Unidade.findByDescricaoUnidade", query = "SELECT u FROM Unidade u WHERE u.descricaoUnidade = :descricaoUnidade")})
