...
public class Recebimentos extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<br.com.siscom.bean.Recebimento> toRemove = new ArrayList<br.com.siscom.bean.Recebimento>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            br.com.siscom.bean.Recebimento r = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(r);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        br.com.siscom.bean.Recebimento r = new br.com.siscom.bean.Recebimento();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<br.com.siscom.bean.Recebimento> merged = new ArrayList<br.com.siscom.bean.Recebimento>(list.size());
            for (br.com.siscom.bean.Recebimento r : list) {
    ...
    private java.util.List<br.com.siscom.bean.Recebimento> list;
