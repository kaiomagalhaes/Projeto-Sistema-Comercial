...
import br.com.siscom.bean.ReqCab;
...
@Entity
@Table(name = "req_det")
@NamedQueries({@NamedQuery(name = "ReqDet.findByCodProduto", query = "SELECT r FROM ReqDet r WHERE r.reqDetPK.codProduto = :codProduto"), @NamedQuery(name = "ReqDet.findByCodReqCab", query = "SELECT r FROM ReqDet r WHERE r.reqDetPK.codReqCab = :codReqCab"), @NamedQuery(name = "ReqDet.findByQtdeReqDet", query = "SELECT r FROM ReqDet r WHERE r.qtdeReqDet = :qtdeReqDet"), @NamedQuery(name = "ReqDet.findByVlrUnitReqDet", query = "SELECT r FROM ReqDet r WHERE r.vlrUnitReqDet = :vlrUnitReqDet"), @NamedQuery(name = "ReqDet.findByVlrTotalReqDet", query = "SELECT r FROM ReqDet r WHERE r.vlrTotalReqDet = :vlrTotalReqDet"), @NamedQuery(name = "ReqDet.findByFlag", query = "SELECT r FROM ReqDet r WHERE r.flag = :flag")})
public class ReqDet implements Serializable {
    ...
    public String toString() {
        return "br.com.siscom.bean.compras.ReqDet[reqDetPK=" + reqDetPK + "]";
    }
