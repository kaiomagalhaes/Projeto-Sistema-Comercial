 ...
 *
 * Created on 1 de Setembro de 2008, 01:51
 */
...
public class ImportaRequisicao extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        siscomjavaPUEntityManager = javax.persistence.Persistence.createEntityManagerFactory("siscomjavaPU").createEntityManager();
        reqDetQuery = siscomjavaPUEntityManager.createQuery("SELECT r FROM ReqDet r WHERE r.flag is null");
        reqDetList = reqDetQuery.getResultList();
